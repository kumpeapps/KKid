...
public struct TMDb_Constants {
    ...
    static let favoriteShowsUrl = "\(baseUrl)/account/1/favorite/tv"
    static let watchlistShowsUrl = "\(baseUrl)/account/1/watchlist/tv"
    ...
    static let searchTVUrl = "\(searchUrl)/tv"
