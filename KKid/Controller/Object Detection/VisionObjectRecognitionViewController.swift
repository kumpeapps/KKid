...
class VisionObjectRecognitionViewController: AVCaptureViewController {
   ...
   override func viewWillDisappear(_ animated: Bool) {
    ...
    func createTextSubLayerInBounds(_ bounds: CGRect, identifier: String, confidence: VNConfidence) -> CATextLayer {
        ...
        processObject(identifier: identifier, confidence: confidence)
        return textLayer
    }
    ...
    open func processObject(identifier: String, confidence: VNConfidence) {
